...
<!--You can modify the text, color, size, number of loops and more on the flash header by
editing the text file (fence.txt) included in the zip file.-->
...
<table width="304" border="0" align="center">
 <tr>
 <td width="298"><div align="left"><strong> Q-1</strong> <strong>: What is not Php
Element?</strong></div></td>
 </tr>
 <tr>
 <td>
 <div align="left">
